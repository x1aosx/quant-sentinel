...
const navGroups = [
  ...
  },
  {
    label: 'AlphaLab',
    items: [
      { to: '/alphalab/training', label: '因子训练', icon: FlaskConical },
      { to: '/alphalab/strategies', label: '策略资产', icon: Library },
      { to: '/alphalab/backtest', label: '策略回测', icon: LineChart },
      { to: '/alphalab/realtime', label: '实时信号', icon: Radio },
    ],
  },
  {
    label: '运营',
...
const titles: Record<string, string> = {
  ...
  '/alphalab/training': 'Alpha 因子研究中心 · 因子训练',
  '/alphalab/strategies': 'Alpha 因子研究中心 · 策略资产',
  '/alphalab/backtest': 'Alpha 因子研究中心 · 策略回测',
  '/alphalab/realtime': 'Alpha 因子研究中心 · 实时信号',
